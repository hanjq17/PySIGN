...
from ..task import Prediction, EnergyForcePrediction, DynamicsPrediction, Contrastive
...
class BenchmarkAtom3dLBA(Benchmark):
    def __init__(self, args_file=None):
        ...
        self.specific_args = {'node_dim': 61, 'edge_attr_dim': 1}
...
class BenchmarkAtom3dLEP(Benchmark):
    def __init__(self, args_file=None):
        ...
        self.specific_args = {'node_dim': 18, 'edge_attr_dim': 1}
